...
## **Instructions**
The first thing to do is install the net_practice.1.9.tgz file on your computer. Then, extract the files into any folder of your choice. Once that's done, run the run.sh file. This shell script will launch a web server and open your preferred web browser to the dedicated page. You have two options: either complete the 10 training exercises or use the evaluation mode , where you'll need to complete 3 exercises from the last 4 exercises in the training mode. For the training mode, once you've finished an exercise and confirmed it with the "check again" button, you can export your configuration using the "get my config" button. This will download a .json file. This is the file that needs to be submit.

## **Resources**
https://www.hobbesworld.com/reseaux/netmask.php - to understand how a mask works with an array of masks, but also specific addresses (private address...) \
https://www.fortinet.com/fr/resources/cyberglossary/tcp-ip - to understand what TCP/IP is \
